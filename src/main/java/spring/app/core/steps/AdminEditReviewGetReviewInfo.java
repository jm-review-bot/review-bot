...
public class AdminEditReviewGetReviewInfo extends Step {
    ...
    public void enter(BotContext context) {
        ...
        StudentReview studentReview = studentReviewService.getStudentReviewsByIdWithFetchReviewUserThemeAndReviewer(Long.parseLong(sStudentReviewToChange)).orElseGet(StudentReview::new);
